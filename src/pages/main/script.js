$(document).ready(function() {
    ...
    $('#price-btn').click(function() {
        $('#price').animatescroll({padding:30});
    });
    $('#specifications-btn').click(function() {
        $('#specifications').animatescroll({padding:60});
    });
    $('#about-btn').click(function() {
        $('#about').animatescroll({padding:100});
    });
    $('#description-btn').click(function() {
        $('#description').animatescroll({padding:60});
    });

    // Пункты мобильного меню

    $('#price-mobile-btn').click(function() {
        $('#price').animatescroll({scrollSpeed:3000, padding:30});
    ...
    $('#specifications-mobile-btn').click(function() {
        $('#specifications').animatescroll({scrollSpeed:3000, padding:60});
        $('#mobile-menu').addClass('mobile-menu-close_js');
        $('#mobile-menu-wrapper').addClass('mobile-menu-close_js');
    });
    $('#about-mobile-btn').click(function() {
        $('#about').animatescroll({scrollSpeed:3000, padding:100});
        $('#mobile-menu').addClass('mobile-menu-close_js');
        $('#mobile-menu-wrapper').addClass('mobile-menu-close_js');
    });
    $('#description-mobile-btn').click(function() {
        $('#description').animatescroll({scrollSpeed:3000, padding:60});
        $('#mobile-menu').addClass('mobile-menu-close_js');
        $('#mobile-menu-wrapper').addClass('mobile-menu-close_js');
    });
